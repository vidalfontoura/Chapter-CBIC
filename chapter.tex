...
Different heuristic approaches have been developed to decrease the computational complexity related to the protein structure determination process. Mono and Multi-objective methods have been used \cite{custodio2004investigation, hsu2003growth, krasnogor2002multimeme, lin2011protein, unger1993genetic, gabriel2012algoritmos}, trying to define which methods have better results.
 ...
 These approaches make use of optimization techniques like Genetic Algorithm, Particle Swarm Optimization, Ant Colony Optimization, Memetic Genetic Algorithm, and Multi-Objective Evolutionary Algorithm. However there is lack of works that explore multi-objective approaches and this motivated the presented chapter. 
...
Two well-known pareto based multi-objective evolutionary algorithms (MOEAs), NSGAII and IBEA,  were used, because of their success when applied on the domain of other problems. Two versions of each algorithm were evaluated: one with the algorithms as they were originally specified and other with modifications in the initialization and mating process. Another motivation for this chapter was the use of pareto based algorithms in order to explore the performance of this type of algorithms when applied to the PSP problem.
