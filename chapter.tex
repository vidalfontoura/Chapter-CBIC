...
The manipulation of a protein structure represented in the HP model requires some attention in order to respect the given problem and avoid unfeasible conformations. Another issue is the difficulty in finding good measures to verify the quality of the solution. The most common measure used for the HP model is to calculate the conformation's energy based on the number of hydrophobic contacts. 
...
%TODO mudar a figura um pouco para ficar diferente do original
...
%TODO modificar o exemplo de cadeia
